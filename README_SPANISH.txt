...
Licencia
  ...
  Este producto está licenciado bajo los términos de la licencia:
  "GNU General Public License Version 2":http://www.gnu.org/licenses/gpl.html
  
  Parte de este producto está basado en el código de Weather Forecast for Plone
  ("The Ingeniweb team":http://www.ingeniweb.com)

  Los iconos usados por este producto son proporcionados por la página web del INM.
